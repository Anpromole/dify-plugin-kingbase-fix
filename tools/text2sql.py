...
class QueryTool(Tool):
    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage]:
        ...
        # ==================【修改开始】==================
        # 针对人大金仓 (Kingbase) 的兼容性修复
        # Kingbase 使用 postgresql 协议，但返回的版本号字符串 SQLAlchemy 无法识别
        # 因此我们需要强制指定 server_version_info 为 (12, 0)，骗过版本检查
        if "postgresql" in db_uri:
            # 仅当配置中未手动指定时添加，避免覆盖用户的高级配置
            if "server_version_info" not in config_options:
                config_options["server_version_info"] = (12, 0)
        # ==================【修改结束】==================
